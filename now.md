...
I look for [a lead full-stack engineer on Next.js and Nest.js](https://mojam.co/careers/lead-full-stack-developer/) to develop a wiki-like product, [a senior Node.js dev]( https://mojam.co/careers/senior-nodejs-developer/) to develop 3rd party CS2 markets integrations and [a product designer](https://mojam.co/careers/product-designer/). If you speak Russian and meet the criteria, please drop me a line [in Telegram](https://t.me/laidrivm) or [on email](laidrivm@gmail.com).

## Developing Mellon

It is a local-first password manager I submitted to the startup program. I [published a prototype](https://mellon.laidrivm.com/), and [write articles on dev process](https://laidrivm.com/how-i-built-mellon-part-1).
...
In January 2025 Nastya and I got married in Georgia. Shortly after, a pineapple green-cheeked parakeet flew to us from the street. We kept him and named Zhablik. Now we can't imagine how we lived without this sweet little pie.

### Learning English

Thanks to [Ian](https://ianspringham.co.uk/).

### Running

Train two or three times for an hour and a half to participate in [Lisbon half-marathon in October](https://www.running-portugal.com/lisbon/marathon/en/half.html).
...
Portuguese bureaucracy is hell. For migrants, it's even worse. The classic "to get paper A, you need to get B, but to get B, you need to get A. No, we won't give you a refusal paper. That's our secret internal regulations. Yes, even though it contradicts our own website". I'm stunned people living in such a wonderful place do such terrible things. [More about this](https://stories.onlyinportugal.com/p/they-make-up-immigration-programs-that-dont-work).

### Talking about fraud

[Filmed for the OVD-Info's YouTube channel](https://www.youtube.com/watch?v=8S77jidaF1A). That's a Russian human rights project. I briefly discuss how fraud works today, the schemes and tools used, and how to protect yourself from it.
...
All my knowledge about infrastructure, except for the Linux theory and practice, I acquired as a self-taught guy. Despite my experience administration k8s cluster or setting up proxy package registry, it will be useful for me to gather my knowledge and get new ideas to improve CI/CD pipelines and overall security.
...
### Studying a podcasts course

I was learning from [the most famous studio](https://course.libolibo.me/podcast-course) of Russian-language podcasts. I had been so inspired by David Graeber's Bullshit Jobs that I was thinking of recording episodes regarding that topic. Yet, I couldn't convert my insiration into a single episode during the course. Hope to fix it one day.
...
Written in Barreiro, Portugal, with a Mar da Palha view.
