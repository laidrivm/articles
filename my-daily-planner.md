...
- How to write things down — the rules that make the system work
- Additions to these rules
- What to write down — where tasks come from
- Where to write things down
- What I tried but didn't work — and why
...
- Day 1: Attach your docs, write motivational letter
- Day 2: Sign and attach motivational letter. Push Eugene to send me the documents
- Day 3: Innovative nature of the project (required field)
- Day 4: Justification of the internationalisation business potential
- Day 5: Financial model
- Day 6: Job creation potential
- Day 7: Estimated turnover in 5th year
- Day 8: Attach Eugene's documents
- …
...
- 14-15:30 interview with Mojam team leads
    - Test the product on the website
    - Look at notes from previous calls, copy team structure
    - Write a couple paragraphs why you want to join Mojam — adapt Emma's pitch
...
- Go to the gym — got sick(
- Go for a run — fuck it
- 19-22 visit the film club at Woop Woop School — didn't sleep at night, skip
...
- Is this time convenient for me?
- Is this easy to reschedule or better to adapt?
- Is this thing worth that much time?
- How do I need to prepare and will I make it?
...
**Messages**: email, chats, SMS. If responding takes more than 10 minutes or to respond "I need to think" — I write it down as a separate task. I combine this approach [with the inbox zero method](https://laidrivm.com/configure-email-inbox#zero-inbox). Because keeping messages unread or unprocessed is also an implicit buffer.
...
For me it's [Notion](https://www.notion.com/):
- These are text documents
- That sync through the cloud between devices
- With a good mobile version
- Where you can easily add a todo block, check it off and drag it around

Popular options I ruled out — but maybe they'll work for someone:
- Physical planner: easy to lose, plus you have to constantly rewrite tasks or mark numbers — what comes after what
- Txt file: locks you to one device
- Apple Notes: locks you in one ecosystem
- Google Docs and Sheets: even from a computer filling them in this format is torture, let alone from a phone
- Telegram saved messages: long messages aren't that easy to edit from phone. Plus, one clumsy swipe and saved messages get deleted entirely from everywhere
- [Trello](https://trello.com/): because boards are overkill. Plus, the service itself noticeably got more complicated after Atlassian bought them

I've heard some people keep daily planners [in Evernote](https://evernote.com/) and [Todoist](https://www.todoist.com/) — but haven't tried them myself.
...
- Didn't set up the system. I planned to just throw food photos into ChatGPT, in a thread with a prompt. The prompt sometimes fucked up. Lacked a trigger to do this for every meal. I often forgot to count snacks between breakfast, lunch and dinner.
- Didn't set enough motivation for myself to overcome resistance to the new habit.
- Didn't react to failure. If a task repeats 10+ times and isn't completed — it's either not needed or incorrectly formulated. Need to remove it and reformulate, but specifically here I never figured out why it didn't work for me.
- Could've been more specific. For example, formulate as: "Every meal → photo → log (link)".
...
- What have gone well?
- What and why have failed?
- What can I change next week?

Then once a month I'll ask AI to:

- Overview completed tasks
- Mention main achievements
- Highlight unfinished tasks or projects to either focus on closing them or drop them
- Suggest further system improvements
...
To my regret, I know only one book in English that is good to build your own system, or understand deeper why and how things works and what else is possible. That's [Do It Tomorrow by Mark Forster](https://www.goodreads.com/book/show/3668.Do_It_Tomorrow_and_Other_Secrets_of_Time_Management) — a terribly written book with wonderful ideas. It essentially describes a task management system too: how to use it, what principles it's built on, and how to apply it in typical situations.

Just in case, I'll mention a few more books and a couple of courses, but they are in Russian:

- [Maxim Dorofeev — Jedi Techniques](https://www.goodreads.com/book/show/34656521). I read this gem three times, and each time discovered something else useful. The book is an applied compilation of ideas. Main topics: why mental resource is more important than time; how to build a system to save it and spend it in the best way; how to interact with people who don't know this.
- [Nikita Maklakhov — It Will Be Done](https://www.goodreads.com/book/show/42629015). Essentially — a more modern version of Jedi Techniques. I myself only read a small piece — but I liked it. I'm more basing on reviews from the people I trust.
- [Nikolai Toverovsky — Managing Projects, People and Yourself](https://www.goodreads.com/book/show/36239873). The "You" section partly retells Do It Tomorrow, and adds chapters about career and self-development.
- [Crash course on shipping projects on time](https://am.changerschool.ru/crash/). Actually, it focuses on shipping projects. But in general, many principles are applicable to non-work tasks. Plus, it describes how to organise your work to do joint projects — and that's close to what I described in this article.
- [How to manage projects in everyday life](https://t-j.ru/pro/proekt/). Like the course above, but with a focus on personal projects like a flat renovation, not work. I'm a co-author.
